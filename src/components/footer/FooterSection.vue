...
<template>
  <footer class="footerSect" id="contact">
    <div class="container footerContainer">
      <div class="footer_titleDiv">
        <h1 class="robotoCondensed site_title">agency</h1>
        <p class="DMsans" style="color: var(--halfwhite)">
          Agency © 2019. All Rights Reserved.
        </p>
      </div>
      <div class="footer_addressDiv">
        <h3 class="robotoCondensed">address</h3>
        <p class="DMsans" style="color: var(--halfwhite)">
          3899 Fusce Rd. Frederick Nebraska 20620
        </p>
        <p>
          <a class="DMsans" href="mailto:info@agency.com">info@agency.com</a>
        </p>
        <p><a class="DMsans" href="tel:+12345678900">+1 (234) 567-89-00</a></p>
      </div>
      <div class="footer_menuDiv">
        <h3 class="robotoCondensed">menu</h3>
        <ul class="DMsans">
...
@media screen {
  ...
  .footer_socialDiv a {
    ...
    width: 3rem;
    height: 3rem;
    background-color: var(--GreySocial);
    text-align: center;
    border-radius: 100px;
  }

  .footer_socialDiv a:hover {
